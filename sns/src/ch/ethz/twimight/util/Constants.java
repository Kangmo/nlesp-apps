...
public final class Constants { 
	...
	// VICDATA don't retry 2 -> 0
	public static final int LOGIN_ATTEMPTS = 0; /** How many times do we attempt to log in before giving up? */
	public static final int TIMELINE_ATTEMPTS = 0; /** How many times do we attempt to update the timeline before giving up? */
...
//	public static final int TIMELINE_ATTEMPTS = 2; /** How many times do we attempt to update the timeline before giving up? */
	...
	// VICDATA decrease number of tweets for request.
	public static final int NR_TWEETS = 20; /** how many tweets to request from twitter in timeline update */
